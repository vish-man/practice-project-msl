 ...
 */   
 PreparedStatement ps1 = con.prepareStatement("update cart set address=?,city=?,state=?,country=?,mobileNumber=?,orderDate=now(),deliveryDate=ADDDATE(CURDATE(),INTERVAL 7 DAY),paymentMethod=?,transactionId=?,status=? where email=? and address is NULL");
